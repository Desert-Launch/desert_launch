...
export const es: Dictionary = {
  ...
  header: {
    ...
    startProject: { label: "Iniciar un proyecto", href: "#contact" },
    langCode: "ES",
  ...
  hero: {
    eyebrow: "Estudio de producto de software · El Cairo",
    title: "De la idea al software listo para producción.",
    lead: "Desert Launch diseña y construye las apps móviles, plataformas web y sistemas internos con los que fundadores y empresas operan: un presupuesto cerrado antes de comprometerse y un año de soporte tras el lanzamiento.",
    primary: { label: "Iniciar un proyecto", href: "#contact" },
    secondary: { label: "Ver nuestro trabajo", href: "#work" },
    responseNote: "Respuesta en menos de 12 horas, directamente del ingeniero que lo construiría.",
    journey: {
      label: "Cómo pasa un proyecto de una idea a un producto en producción",
      statusLabel: "Estado del proyecto",
      statuses: [
        "Entendiendo el problema",
        "Definido y presupuestado",
        "En construcción · hito a hito",
        "En producción",
      ],
      stageLabel: "Etapa",
      stages: [
      ...
      fragments: [
        "reservas.xlsx",
        "hilo de WhatsApp",
        "hoja del día en papel",
        "3 herramientas desconectadas",
      ],
      scope: {
        title: "Resumen de alcance · precio cerrado",
        lines: [
          "Reservas de clientes · 1 público",
          "Panel del equipo · 4 hitos",
          "Pagos · 30 % por adelantado",
        ],
      },
      ui: {
        app: "Recepción",
        ...
        headline: "Hoy · 14 reservas",
        live: "En vivo",
        rows: [
          { label: "09:30 · Cliente 1", state: "confirmada" },
          { label: "11:00 · Cliente 2", state: "nueva" },
        ],
      },
      phone: { title: "Mis reservas", slot: "18:00", slotNote: "Grupo", day: "Jue", cta: "Reservar" },
      captions: {
        idle: "De hojas de cálculo y papel a un solo producto con el que opera su negocio.",
        milestones: "Hitos",
        terms: "30 % por adelantado, el resto por hito aceptado",
        live: "Publicada en ambas tiendas",
        liveNote: "en sus propias cuentas de desarrollador",
        since: "Desde el lanzamiento",
        sinceValue: "v1.0 → v1.4 · 12 meses de soporte incluidos",
      },
      alts: [
        "El panel de una plataforma terminada, en producción",
        "Una app móvil terminada, en producción",
      ],
    },
    proof: [
      { label: "Productos entregados", value: "8", note: "Apps móviles, plataformas multirrol y sistemas empresariales privados." },
      { label: "Primera respuesta", value: "Menos de 12 h", note: "Del ingeniero que lo construiría. Sin gestores de cuenta." },
      { label: "Soporte tras el lanzamiento", value: "12 meses", note: "Correcciones, actualizaciones de SO y tiendas. Cambios pequeños gratis durante tres." },
      { label: "Propiedad del código", value: "Suya", note: "Código, PI, alojamiento y cuentas de tiendas a su nombre desde el primer día." },
    ],
  },
  work: {
    kicker: "Proyectos destacados",
    title: "Productos en las tiendas, plataformas que operan un negocio cada día",
    intro:
      "Ocho productos entre móvil de consumo, plataformas multirrol y sistemas empresariales privados. Cuando una app es pública, el enlace a la tienda está en el caso.",
    attribution:
    ...
    caseLabels: { problem: "Problema", built: "Construimos", outcome: "Resultado" },
    moreHeading: "Cinco productos más",
    ...
    projects: {
      "q-fight-gym": {
        ...
        case: {
          problem: "Los socios llamaban a recepción para reservar cada sesión.",
          built: "Elección de plan y entrenador y reserva de sesiones individuales o grupales en la app, con pasarela de pago.",
          outcome: "Publicada en ambas tiendas para un gimnasio que la usa a diario.",
        },
      },
      "al-muslim": {
        ...
        case: {
          problem: "Las apps de hábito diario se instalan una vez y se olvidan.",
          built: "Corán, adhkar y duas, horarios de oración precisos y qibla, con recordatorios pensados para la retención y no para la instalación.",
          outcome: "Interfaz completa en árabe e inglés con diseño de derecha a izquierda, publicada en ambas tiendas.",
        },
      },
      ezhal: {
        ...
        case: {
          problem: "Tres públicos — clientes, técnicos de campo, gerentes — una sola operación.",
          built: "Tres apps por rol desde una única base de código: reservas, cola de trabajos de campo y supervisión.",
          outcome: "Seguimiento de técnicos en vivo, suscripciones, monedero, puntos y pases de Apple Wallet en producción.",
        },
      },
      "xera-lab": {
  ...
  services: {
    kicker: "Servicios",
    title: "Seis cosas que construimos, y lo que tiene al final",
    intro:
  ...
  demos: {
    ...
    intro:
      "Seis demos funcionales. Reserve, pida o envíe una consulta en el sitio público y luego abra el panel del personal y vea cómo llega. Nada que instalar, sin registro.",
    disclaimer:
  ...
  pricing: {
    kicker: "Inversión",
    title: "Dónde se sitúa su proyecto",
    intro: "Cuatro tramos para ubicarse antes de escribirnos. Nada de esto es un presupuesto.",
    labels: { typical: "Duración típica", youGet: "Obtiene", fits: "Encaja con" },
    brackets: [
      {
        range: "Menos de 3.000 $",
        summary: "Un sitio web de negocio, o diseño y consultoría por sí solos.",
        typical: "2 semanas – 1 mes",
        youGet: "Un sitio en línea en su propio alojamiento, que puede ampliar",
        fits: "Desarrollo web · Diseño UI/UX · Consultoría técnica",
      },
      {
        range: "3.000 – 8.000 $",
        summary: "Un portal, un sistema interno o un MVP con usuarios reales.",
        typical: "1 – 2 meses",
        youGet: "Un producto funcional ante usuarios reales, y qué construir después",
        fits: "MVP · Sistemas internos · Portales de clientes",
      },
      {
        range: "8.000 – 20.000 $",
        summary: "Un producto móvil con cuentas y pagos, en ambas tiendas.",
        typical: "2 – 4 meses",
        youGet: "Una app iOS y Android publicada en sus propias cuentas de desarrollador",
        fits: "Apps móviles · Pagos · Panel de administración",
      },
      {
        range: "Más de 20.000 $",
        summary: "Apps de cliente, campo y administración sobre una base de código.",
        typical: "Presupuestado según alcance",
        youGet: "Varias apps por rol y la plataforma detrás",
        fits: "Plataformas multirrol · Reconstrucciones · Operaciones en vivo",
      },
    ],
    checks: [
      "Llamada de alcance gratuita",
      "Un precio cerrado en USD — nunca por horas",
      "30 % por adelantado, el resto por hito aceptado",
    ],
    link: "Cómo funciona el precio",
  },
  why: {
    kicker: "Por qué Desert Launch",
    title: "Cuatro compromisos que quitan el riesgo de su lado de la mesa",
    features: [
      {
        title: "Conoce el precio antes de comprometerse",
        body: "Un precio cerrado por escrito en USD tras una llamada de alcance gratuita. Sin facturación por horas, sin sorpresas por cambios, y una respuesta honesta si una versión más pequeña cumple su objetivo.",
        before: "Facturación por horas y un total que no deja de moverse",
        after: "Un único precio cerrado en USD, acordado antes de empezar",
      },
      {
        title: "Es dueño del código y de las cuentas",
        body: "Código, propiedad intelectual, alojamiento y cuentas de tiendas a su nombre desde el primer día. Si dejamos de trabajar juntos, nada suyo se va con nosotros.",
        before: "Código y cuentas en manos de la agencia",
        after: "Código, PI, alojamiento y tiendas a su nombre desde el primer día",
      },
      {
        title: "Ve software funcionando, no capturas",
        body: "Tres o cuatro hitos. Abre y usa la versión antes del siguiente pago, y un hito no se acepta hasta que usted lo dice.",
        before: "Presentaciones de estado y porcentajes de avance",
        after: "Una versión que abre y acepta antes de facturarse",
      },
      {
        title: "Habla con el ingeniero, durante un año tras el lanzamiento",
        body: "Sin gestores de cuenta entre usted y quien escribe el código. Doce meses de correcciones y actualizaciones de SO y tiendas; cambios pequeños gratis los tres primeros.",
        before: "Un gestor de cuenta entre usted y el código",
        after: "El ingeniero que lo escribió, respondiendo un año después",
      },
    ],
    founder: {
      kicker: "Con quién trabaja",
      title: "Su proyecto nunca pasa de ventas a un equipo de desarrollo que no conoce.",
  ...
  process: {
    ...
    intro: "Cinco pasos. Cada uno termina con algo que puede abrir, y nada se paga antes de haber visto el paso anterior.",
    youShareLabel: "Usted aporta",
    weDoLabel: "Nosotros hacemos",
    deliverableLabel: "Usted recibe",
    terms: {
      note: "Nada se paga antes de haber visto el paso anterior.",
      steps: [
        "Llamada de alcance gratuita",
        "30 % por adelantado",
        "Por hito aceptado",
    ...
    steps: [
      {
        ...
        chip: "Gratis · sin compromiso",
        payment: "Nada que pagar",
        youShare: "Cómo funciona el negocio hoy, quién usará el sistema y qué debe ser cierto el día del lanzamiento.",
        body: "Definir los usuarios, acotar el alcance y quitar la complejidad que no se gana su sitio.",
        deliverable: "Un resumen de alcance por escrito y un sí o no honesto.",
      },
      {
        n: "2",
        title: "Presupuesto",
        chip: "Precio cerrado en USD",
        payment: "El 30 % inicial arranca el trabajo",
        youShare: "El presupuesto que tiene en mente y cualquier fecha a la que apunte.",
        body: "Entregables, plan de hitos, calendario y un único precio cerrado; nada empieza sin su aprobación por escrito.",
        deliverable: "Un presupuesto cerrado y un calendario de hitos.",
      },
      {
        n: "3",
        title: "Construcción",
        chip: "Tres o cuatro hitos",
        payment: "Pagado por hito aceptado",
        youShare: "Sus comentarios sobre cada versión de hito. Preguntas respondidas el mismo día, por WhatsApp.",
        body: "Construir hito a hito, con software funcionando en cada uno, no capturas de pantalla.",
        deliverable: "Una versión que puede abrir y usar en cada hito.",
      },
      {
        n: "4",
        title: "Lanzamiento",
        chip: "Revisión de tiendas gestionada",
        payment: "Último hito",
        youShare: "Sus propias cuentas de tiendas, alojamiento y dominio, creadas a su nombre desde el primer día.",
        body: "Envío a las tiendas, alojamiento, dominios y analítica, más el ida y vuelta con la revisión hasta que esté publicada.",
        deliverable: "Una app publicada o una plataforma en línea, a su nombre.",
      },
      {
        n: "5",
        title: "Soporte",
        chip: "12 meses incluidos",
        payment: "Sin coste extra",
        youShare: "Cualquier fallo, directamente al ingeniero que lo construyó.",
        body: "Correcciones, actualizaciones de sistema y tiendas, y mantenerlo funcionando. Cambios pequeños gratis los tres primeros meses.",
        deliverable: "Un año de correcciones y actualizaciones sin coste extra.",
      },
    ],
  },
  testimonials: {
  ...
  contact: {
    kicker: "Empezar",
    title: "¿Tiene un producto en mente? Definamos el camino más rápido al lanzamiento.",
    intro:
      "Describa la idea de producto, el sistema actual o el proceso que no deja de fallar. Nada le compromete a nada.",
    steps: [
      { title: "Nos cuenta el proyecto", note: "Cinco campos, o un mensaje de WhatsApp. Sin documentos." },
      { title: "Lo leemos y respondemos en menos de 12 horas", note: "Del ingeniero, no de un gestor de cuenta." },
      { title: "Una llamada de alcance gratuita", note: "Qué haría falta, y si una versión más pequeña le sirve." },
      { title: "Recibe un alcance por escrito y un precio cerrado", note: "Entonces decide. No debe nada hasta tener ambos delante." },
    ],
